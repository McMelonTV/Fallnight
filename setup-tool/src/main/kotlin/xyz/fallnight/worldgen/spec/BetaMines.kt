...
private val premiereMineTemplates = listOf(
    PremiereMineTemplate(
        ...
        BlockPos(-46, 15, -80),
        BlockBox(BlockPos(62, 40, 54), BlockPos(87, 47, 86)),
    ...
    PremiereMineTemplate(
        ...
        "Mine2-Aquatic.schem",
        BlockPos(119, 33, -69),
        BlockBox(BlockPos(59, 30, 48), BlockPos(84, 37, 80)),
    ...
    PremiereMineTemplate(
        ...
        BlockPos(266, 33, -69),
        BlockBox(BlockPos(63, 40, 52), BlockPos(88, 47, 84)),
    ...
    PremiereMineTemplate(
        ...
        BlockPos(422, 58, -60),
        BlockBox(BlockPos(66, 22, 48), BlockPos(91, 29, 80)),
    ...
    PremiereMineTemplate(
        ...
        "Mine5-Egypt.schem",
        BlockPos(621, 58, -70),
        BlockBox(BlockPos(37, 14, 49), BlockPos(72, 21, 79)),
    ...
    PremiereMineTemplate(
        ...
        "Mine6-Space.schem",
        BlockPos(773, 29, -104),
        BlockBox(BlockPos(62, 45, 96), BlockPos(92, 52, 134)),
    ...
    PremiereMineTemplate(
        ...
        "Mine7Space.schem",
        BlockPos(1102, 48, -54),
        BlockBox(BlockPos(58, 16, 55), BlockPos(83, 23, 82)),
        setOf("minecraft:end_stone"),
    ),
    PremiereMineTemplate(
        "OakForest",
        ...
        BlockPos(1386, 63, -24),
        BlockBox(BlockPos(27, 1, 35), BlockPos(50, 8, 57)),
    ...
    PremiereMineTemplate(
        ...
        BlockPos(1546, 36, -45),
        BlockBox(BlockPos(11, 32, 29), BlockPos(82, 39, 129)),
    ...
    PremiereMineTemplate(
        ...
        BlockPos(1661, 31, -28),
        BlockBox(BlockPos(48, 34, 27), BlockPos(101, 41, 68)),
    ...
    PremiereMineTemplate(
        ...
        BlockPos(2027, 26, -63),
        BlockBox(BlockPos(34, 25, 109), BlockPos(57, 32, 128)),
        setOf("minecraft:dirt", "minecraft:green_terracotta"),
    ),
    PremiereMineTemplate(
        "CalicoDesert",
        ...
        BlockPos(1276, 67, -34),
        BlockBox(BlockPos(34, 1, 43), BlockPos(51, 8, 61)),
    ...
    PremiereMineTemplate(
        ...
        BlockPos(943, 44, -49),
        BlockBox(BlockPos(68, 25, 36), BlockPos(88, 32, 74)),
        setOf("minecraft:dirt", "minecraft:green_terracotta"),
    ),
    PremiereMineTemplate(
        "Tower",
        "Mine15-Tower.schem",
        BlockPos(2184, 22, -40),
        BlockBox(BlockPos(62, 29, 52), BlockPos(97, 36, 103)),
        setOf("minecraft:dirt", "minecraft:green_terracotta"),
    ),
)
